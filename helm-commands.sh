...
kubectl create ns istiosample-canary

kubectl label namespace istiosample-canary istio-injection=enabled
...
helm upgrade  --install --namespace istiosample-canary --values ./productpage/chart/productpage/values.yaml --set productionDeployment.image.repository=istiosampleacr.azurecr.io/istiosample/productpage,productionDeployment.image.tag=35,productionDeployment.weight=100,productionDeployment.replicaCount=2,canaryDeployment.image.repository=istiosampleacr.azurecr.io/istiosample/productpage,canaryDeployment.image.tag=35,canaryDeployment.replicaCount=0,canaryDeployment.weight=0 --wait productpage ./productpage/chart/productpage

# CANARY 10 percent
helm upgrade  --install --namespace istiosample-canary --values ./productpage/chart/productpage/values.yaml --set productionDeployment.image.repository=istiosampleacr.azurecr.io/istiosample/productpage,productionDeployment.image.tag=35,productionDeployment.weight=90,productionDeployment.replicaCount=2,canaryDeployment.image.repository=istiosampleacr.azurecr.io/istiosample/productpage,canaryDeployment.image.tag=87,canaryDeployment.replicaCount=2,canaryDeployment.weight=10 --wait productpage ./productpage/chart/productpage
...
helm template --namespace istiosample-canary --values ./productpage/chart/productpage/values.yaml --set productionDeployment.image.repository=istiosampleacr.azurecr.io/istiosample/productpage,productionDeployment.image.tag=35,productionDeployment.replicaCount=2,productionDeployment.weight=75,canaryDeployment.image.repository=istiosampleacr.azurecr.io/istiosample/productpage,canaryDeployment.image.tag=83,canaryDeployment.replicaCount=2,canaryDeployment.weight=25  ./productpage/chart/productpage/ > ./helm-template-output_v1.yaml